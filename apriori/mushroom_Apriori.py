...
class Mushroom:
    ...
    def __init__(self):
        ...
        with open('/Users/sgcx054/PycharmProjects/Harden/apriori/Mushroom.txt', 'r') as f:
...
if __name__ == '__main__':
    start = time.perf_counter()
    mushroom = Mushroom()
    #mushroom.sample_dataset(0.03)
    mushroom.unitfiy()
    #mushroom.unitfiy_sample_dataset()
    mushroom.getFis(0.7, 1)
    #mushroom.getFis_sample_dataset(0.025, 1)
    #mushroom.analysis_reault()
    elapsed = (time.perf_counter() - start)
