    ...
    def becomedict(self):
        ...
        for i in range(self.row_groupmembership):
            if self.dataset_youtube_groupmembership[i][0] in self.dict_youtube_groupmembership:
                self.dict_youtube_groupmembership[self.dataset_youtube_groupmembership[i][0]].append(
                    self.dataset_youtube_groupmembership[i][1])
            else:
                self.dict_youtube_groupmembership[self.dataset_youtube_groupmembership[i][0]] = [
                    self.dataset_youtube_groupmembership[i][1]]
